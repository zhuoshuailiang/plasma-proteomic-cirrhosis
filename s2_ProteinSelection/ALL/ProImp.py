...
#查看mydf的CIRtotal_interuse的平均值
# df = mydf[(mydf['cirtotal'] == 1)]
# print(df['CIRtotal_interuse'].mean())
# df5 = df[(df['CIRtotal_interuse'] <= 5*365)]
# df3 = df[(df['CIRtotal_interuse'] <= 3*365)]
# df10 = df[(df['CIRtotal_interuse'] <= 10*365)]
# df100 = df[(df['CIRtotal_interuse'] >= 10*365)]
# print(mydf['CIRtotal_interuse'].mean())
...
my_imp_df.to_csv(outpath + 'ALL/ProImportance.csv', index = False)

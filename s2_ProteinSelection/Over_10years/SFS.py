...
f = pro_f_lst[0]
f = pro_f_lst[1]
for f in pro_f_lst[:100]: # 【10】: number of features to be selected
    tmp_f.append(f)
    my_X = mydf[tmp_f]
    AUC_cv = []
    ...
    for fold_id in fold_id_lst:
        ...
        my_lgb = LGBMClassifier(objective='binary', metric='auc', is_unbalance=True,  n_jobs=16, verbosity=-1, seed=2024)
